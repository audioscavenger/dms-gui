...
class APIHandler(http.server.BaseHTTPRequestHandler):
  ...
  def do_POST(self):
    ...
    try:
      ...
      if content_bearer == DMS_API_KEY:
        if not command:
          ...
          try:
            ...
            print(f"[dms-gui] API: Executing command: {command}")
            ...
            # print(f"[dms-gui] ddebug: result: {result}")  #  CompletedProcess(args='/usr/local/bin/setup alias list', returncode=0, stdout='...
            ...
            # print(f"[dms-gui] ddebug: response_message\n{response_message}")
      ...
      self.end_headers()
      print(f"[dms-gui] API: Sending response_message: {response_message}")
