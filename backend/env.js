...
export var live = {
  ...
  // doveadm API port, possible to but not used
...
live.DMS_API_KEY = os.environ.get('live.DMS_API_KEY', 'please-restart-dms') # generated by bms-gui on first start and added into DMS compose
